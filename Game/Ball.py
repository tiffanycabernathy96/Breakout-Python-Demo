...
class Ball(GameObject):
    ...
    def changeDirection(self, gameObject):
        ...
        if objectPosition[1] < position[1] < objectPosition[1] + objectSize[1] and \
                objectPosition[0] < position[0] < objectPosition[0] + objectSize[0]:
            self.setPosition((position[0], objectPosition[1] + objectSize[1]))
            self.__direction[1] *= -1

        elif objectPosition[1] < position[1] + size[1] < objectPosition[1] + objectSize[1] and \
                objectPosition[0] < position[0] < objectPosition[0] + objectSize[0]:
            self.setPosition((position[0], objectPosition[1] - objectSize[1]))
            self.__direction[1] *= -1

        elif objectPosition[0] < position[0] + size[0] < objectPosition[0] + objectSize[0]:
